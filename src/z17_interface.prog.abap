...
CLASS lcl_rental IMPLEMENTATION.
  ...
  METHOD lif_partner~get_partner_info.
    rt_info = VALUE #( ( attribute = 'TYPE' value = 'RENTAL' ) ( attribute = 'VEHICLES' value = lines( mt_vehicles ) ) ).
  ENDMETHOD.
...
CLASS lcl_carrier IMPLEMENTATION.
  ...
  METHOD lif_partner~get_partner_info.
    rt_info = VALUE #( ( attribute = 'TYPE' value = 'CARRIER' ) ( attribute = 'PLANES' value = lines( mt_planes ) ) ).
  ENDMETHOD.
...
DATA: go_airplane TYPE REF TO lcl_airplane,
      ...
      gt_partners TYPE STANDARD TABLE OF REF TO lif_partner,
...
* Create some vehicles.
  ...
  LOOP AT gt_partners INTO go_partner.
    gt_single_partner = go_partner->get_partner_info(  ).
